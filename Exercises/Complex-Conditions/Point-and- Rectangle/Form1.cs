...
namespace Point_and__Rectangle
{
    public partial class FormPointAndRectangle : Form
    {
        ...
        private void buttonDrow_Click(object sender, EventArgs e)
        {
            Draw();
        }
        ...
        private void Draw()
        {
            ...
            //rectangle and point in orser to fit them well in picture box
            ...
            //calcilate the scalled pint soordinates
            ...
            {
                //Draw the background (white area)
                g.Clear(Color.White);
                ...
                //Sraw the point (scalled to picture box size)
